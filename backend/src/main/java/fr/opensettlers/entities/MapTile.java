...
public class MapTile {
     ...
     * Updated by {@link fr.opensettlers.state.TerritoryManager}.
     */
    private int territoryOwner = -1;

    /**
     * Whether a geologist already surveyed this tile.
     */
    private boolean surveyed = false;

    /**
     * Sign left by a geologist: the ore found here, or {@code null} when the
     * survey found nothing (or no survey happened yet — see {@link #surveyed}).
     */
    private ResourceType geologistSign;
